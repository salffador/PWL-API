...
$("#form-login-btn").on('click', function(e) {
    ...
    if (!form.checkValidity()) {
        ...
        console.log("Form Data (Login):", Array.from(formData.entries()));
        ...
        axios.post(url, formData, apiHeaders)
            .then(function(response) {
                ...
                // Debugging: Tambahkan log untuk memastikan Swal.fire dipanggil
                ...
                Swal.fire({
                    ...
                    showConfirmButton: false,
                    timer: 3000 // Memperpanjang waktu tampil notifikasi
                });
                setTimeout(function() {
                    window.location = baseUrl;
                }, 3000); // Memperpanjang waktu tunggu sebelum redirect
            })
            .catch(function(error) {
                console.log('[ERROR] response..', error);
...
$("#form-register-btn").on('click', function(e) {
    ...
    if (!form.checkValidity()) {
        ...
        console.log("Form Data (Register):", Array.from(formData.entries()));
